...
4. For grading, use a delay_ms of 41 for Profile A and 81 for Profile B. (Or sometime 45,85 as i have noticed sometimes 41,81 fail, but ONLY A FEW TIMES, not always, it has worked with 41,81 most of the times, this can be due to system noise and randomness)
...
8. What Break My Code: If the delay_ms is less than the delay_max_ms(max delay) of the profile to be tested, my code will fail. delay_ms = 1 + delay_max_ms for profile , hence 41 and 81 ms work for me in profile A and B respectively.
